...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('images/rafft.png') }}">
    <title>Rooft Restaurant &mdash; Food Specialty </title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="main-wrapper">
                  ...
                  <div class="carousel-inner">
                    <div class="container">
                      <div class="carousel-caption fadeInUp animated" style="bottom:0;top:200px">
                        <h2 class="display-1" style="color:#fff;">Rooft Restaurant</h2>
                        <p class="h2" style="color: #ddd;padding-top:20px;padding-bottom: 20px">"Menu Restoran ala TOP Global Coblong"</p>
                      </div>
                    </div>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon -->
                        <b><img src="{{asset('images/rafft.png')}}" alt="homepage" class="dark-logo" /></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#hidangan">Menu Makanan</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#reservasi">Reservasi/Pemesanan</a>
                        </li>
        ...
        <div id="about">
            <div class="row" style="background-image:url({{ asset('resto/images/wood_1.png')}});">
              ...
              <div class="col-md-6" style="padding:30px 50px;">
                ...
                <p class="lead" style="color:#a99c92;font-weight: 300">Rooft Restaurant, Restoran dengan gaya khas Western dan Sundanesse yang sangat cocok untuk berbagai acara dan kebutuhan. Dikenal sejak tahun 2016, Kami menggunakan bahan - bahan yang berkualitas dan dipilah secara baik dari sumbernya sehingga menghasilkan hasil masakan yang lezat dan berkualitas. Rooft Restaurant menyediakan tempat untuk anda yang ingin berbagi momen bersama orang - orang disekitar anda melalui makanan yang kami sediakan, mari pesan tempat anda sekarang.</p>
              </div>
            </div>
        </div>
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          <h3 class="display-4" style="color:#5e493a;font-size: 40px ;">"Makan adalah jalan ninjaku. Rooft Restaurant mengirim hobiku ke tingkatan selanjutnya."</h3>
                          <p class="h4" style="color: gray; padding-top:20px;padding-bottom: 20px">Muh Nur Sanjaya</p>
                        </div>
                      </div>
                    </div>
                    <div class="carousel-item" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          ...
                          <p class="h2" style="color: gray;padding-top:20px;padding-bottom: 20px">Faisal Alfikri</p>
                        </div>
                      </div>
                    </div>
					...
					<div class="carousel-item" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          <h3 class="display-1" style="color:#5e493a;font-size: 40px ;">"Ke Bandung harus mampir ke restaurant ini!!!."</h3>
                          <p class="h2" style="color: gray;padding-top:20px;padding-bottom: 20px">MT Abrori</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="carousel-item" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          <h3 class="display-1" style="color:#5e493a;font-size: 40px ;">"Pelayanannya sangat bagus, apalagi restorannya, MANTAP."</h3>
                          <p class="h2" style="color: gray;padding-top:20px;padding-bottom: 20px">Arief Syafaat</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div id="reservasi" class="container">
            <h2 class="display-4" style="text-align: center;color:#5e493a;padding:50px 0;">Untuk Reservasi</h2>
                ...
                <div class="col-md-6">
                    ...
                    <ul>
                        <li style="padding-left: 50px;margin-bottom: 10px">
                            ...
                            Jalan Dipatiukur no. 28, <br> Kecamatan Coblong, Kota Bandung
                        </li>
                        <li style="padding-left: 50px;margin-bottom: 10px"><i class="icon-phone" style="position: absolute;left: 20px"></i> 081320897564</li>
                        <li style="padding-left: 50px;margin-bottom: 10px"><i class="icon-envelope" style="position: absolute;left: 20px"></i>Rafftclub@gmail.com</li>
                        <li style="padding-left: 50px;margin-bottom: 10px"><i class="icon-globe" style="position: absolute;left: 20px"></i> <a class="text-info" href="https://www.instagram.com/bacottofficial/">https://www.instagram.com/bacottofficial/</a>
                    </ul>
                </div>
                <div class="col-md-6">
                    ...
                    <form action="{{URL('pelanggan/register')}}" method="post" enctype="multipart/form-data">
                        ...
                        <p>Already have an account? <a href="{{URL('pelanggan/login')}}"><u>Masuk</u></a></p>
                    </form>
                    @endif
                </div>
            </div>
        ...
        <div id="team" class="col-md-12" style="background-image:url({{ asset('resto/images/slide_3.jpg')}});background-size: cover;padding-bottom: 50px">
            <div class="container">
                <h2 class="display-4" style="text-align:center;color:#fff;padding:50px 0;">Team (Barudak)</h2>
                <div class="row justify-content-center" style="padding: 15px">
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/arief.jpg')}}" title="Arief" class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/sandy.jpg')}}" title="Sandy" class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/faisal.jpg')}}" title="Faisal" class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                </div>
                <div class="row justify-content-center" style="padding: 15px">
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/fathan.jpg')}}" title="fathan" class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/ary.jpg')}}" title="Ary" class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/thoriq.jpg')}}" title="Thoriq" class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                </div>
                <div class="row justify-content-center" style="padding: 20px">
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/barudak.jpg')}}" title="Barudak Pict" class="rounded img-responsive" style="cursor: pointer;">
                    </div>
                </div>
            </div>
        </div>

        <footer class="footer" style="text-align: center;"> © Template dari : <a href="https://colorlib.com">Colorlib <span id="tes"></span></a></footer>
